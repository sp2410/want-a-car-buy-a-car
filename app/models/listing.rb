...
class Listing < ActiveRecord::Base
	...
	def self.import_listings(file)	
		...
		# begin
			# p valid_listings
			 Listing.import valid_listings, on_duplicate_key_update: { conflict_target: [:title, :vin], columns: [:user_id, :newused, :stocknumber, :model, :year, :trim, :miles, :enginedescription,:cylinder,:fuel,:transmission,  :price, :color, :interiorcolor, :options, :description,:city, :state, :zipcode, :approved]}
