...
RSpec.describe "new_dealer_contats/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit new_dealer_contat form" do
    render

    assert_select "form[action=?][method=?]", new_dealer_contat_path(@new_dealer_contat), "post" do
