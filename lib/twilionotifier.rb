	...
	def notifybidding(loosers, product_details)
		loosers.each do |looser|
			begin
				...
				to: looser.to_s,
				body: "TDCAuctionService: Sorry! You were outbid on #{product_details[1].to_s}: Follow Link and Bid To Win! https://www.tdcautoauction.com/products/#{product_details[0].to_s}"
			)
